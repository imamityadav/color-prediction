...
define('CALLBACK_URL', 'https://indiawinn.com/payment-success.php'); //use your website url where paytm return payment response like this -> http://your_website_url/how-to-integrate-paytm-payment-gateway-in-php-with-demo-download/TxnStatus.php"
